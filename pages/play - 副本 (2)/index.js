...
Page({
  onReady: function (e) {
    this.fetch('http://www.88dushu.com/xiaoshuo/0/511/133799.html')
  ...
  // 获取音频地址
  buildUrl(txt) {
    return 'https://tsn.baidu.com/text2audio?lan=zh&ctp=1&cuid=abcdxxx&tok=24.f28935c504bb05da2099b371406a878c.2592000.1521978785.282335-10531269&tex=' + txt + '&vol=9&per=0&spd=5&pit=5'
  },
  // 获取数据
  fetch(urlStr) {
    var that = this;
